...
- Creates and configures one PowerVS instances for SAP NetWeaver that is based on best practices and install S4HANA software.
...
|------|-------------|------|---------|:--------:|
| <a name="input_ansible_sap_solution"></a> [ansible\_sap\_solution](#input\_ansible\_sap\_solution) | HANA Installation parameters | <pre>object(<br>    {<br>      enable                       = bool<br>      solution                     = string<br>      db_master_password           = string<br>      db_sid                       = string<br>      db_instance_number           = string<br>      swpm_sid                     = string<br>      swpm_pas_instance_nr         = string<br>      swpm_ascs_instance_nr        = string<br>      swpm_master_password         = string<br>      swpm_ddic_000_password       = string<br>      swpm_db_system_password      = string<br>      swpm_db_systemdb_password    = string<br>      swpm_db_schema_abap          = string<br>      swpm_db_schema_abap_password = string<br>      swpm_db_sidadm_password      = string<br>    }<br>  )</pre> | <pre>{<br>  "db_instance_number": "00",<br>  "db_master_password": "NewPass$321",<br>  "db_sid": "HDB",<br>  "enable": true,<br>  "solution": "s4hana",<br>  "swpm_ascs_instance_nr": "02",<br>  "swpm_db_schema_abap": "SAPHANADB",<br>  "swpm_db_schema_abap_password": "NewPass$321",<br>  "swpm_db_sidadm_password": "NewPass$321",<br>  "swpm_db_system_password": "NewPass$321",<br>  "swpm_db_systemdb_password": "NewPass$321",<br>  "swpm_ddic_000_password": "NewPass$321",<br>  "swpm_master_password": "NewPass$321",<br>  "swpm_pas_instance_nr": "01",<br>  "swpm_sid": "S4H"<br>}</pre> | no |
