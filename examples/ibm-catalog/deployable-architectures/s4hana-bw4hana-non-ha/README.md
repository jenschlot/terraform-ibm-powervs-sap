...
| <a name="input_db_instance_number"></a> [db\_instance\_number](#input\_db\_instance\_number) | SAP domain to be set for entire landscape. Set to null or empty if not configuring OS. | `string` | n/a | yes |
| <a name="input_db_master_password"></a> [db\_master\_password](#input\_db\_master\_password) | SAP domain to be set for entire landscape. Set to null or empty if not configuring OS. | `string` | n/a | yes |
| <a name="input_db_sid"></a> [db\_sid](#input\_db\_sid) | SAP domain to be set for entire landscape. Set to null or empty if not configuring OS. | `string` | n/a | yes |
...
| <a name="input_swpm_ascs_instance_nr"></a> [swpm\_ascs\_instance\_nr](#input\_swpm\_ascs\_instance\_nr) | SAP domain to be set for entire landscape. Set to null or empty if not configuring OS. | `string` | n/a | yes |
| <a name="input_swpm_master_password"></a> [swpm\_master\_password](#input\_swpm\_master\_password) | SAP domain to be set for entire landscape. Set to null or empty if not configuring OS. | `string` | n/a | yes |
| <a name="input_swpm_pas_instance_nr"></a> [swpm\_pas\_instance\_nr](#input\_swpm\_pas\_instance\_nr) | SAP domain to be set for entire landscape. Set to null or empty if not configuring OS. | `string` | n/a | yes |
| <a name="input_swpm_sid"></a> [swpm\_sid](#input\_swpm\_sid) | SAP domain to be set for entire landscape. Set to null or empty if not configuring OS. | `string` | n/a | yes |
